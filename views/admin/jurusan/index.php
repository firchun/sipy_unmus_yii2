...
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    <div class="card-header cursor-pointer">
        ...
        <a href="<?= Url::to(['create']) ?>" class="btn  btn-light btn-active-primary align-self-center">
    ...
    <div class="card-body p-9">
        ...
        <div class="table-responsive">
            <?= DataTables::widget([
                ...
                'clientOptions' => [
                    // "lengthMenu" => [[20, -1], [20, 50, Yii::t('app', "All")]],
                    "info" => true,
                    "responsive" => true,
                    "dom" => '<"row"<"col-sm-6"B><"col-sm-6">>" + "<"row"<"col-sm-6"l><"col-sm-6"f>>" +
                        "<"row"<"col-sm-12"tr>>" +
