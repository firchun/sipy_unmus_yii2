...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo Yii::$app->request->baseUrl; ?>/assets/dist/assets/media/logos/favicon.ico" />
    <!--begin::Fonts-->
...
<body id="kt_body" class="bg-body">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-center flex-column-fluid p-10">
            <!--begin::Illustration-->
            <img src="<?php echo Yii::$app->request->baseUrl; ?>/assets/dist/assets/media/illustrations/sigma-1/18.png" alt="" class="mw-100 mb-10 h-lg-450px" />
            <!--end::Illustration-->
            <!--begin::Message-->
            <h1 class="fw-bold mb-10" style="color: #A3A3C7">Seems there is nothing here</h1>
            <!--end::Message-->
            <!--begin::Link-->
            <a href="../../demo2/dist/index.html" class="btn btn-primary">Return Home</a>
            <!--end::Link-->
        </div>
