										...
										<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
											...
											<div class="d-flex flex-column">
												...
												<div class="d-flex align-items-center mb-2">
													<a href="#" class="text-gray-900 text-hover-primary fs-1 fw-bolder me-1"><?= Yii::$app->user->identity->nama_lengkap ?></a>
													<a href="#">
												...
												<!--begin::Info-->
												<?php if (!Yii::$app->user->identity->role == 1) : ?>
													<div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2 border border-gray-300 border-dashed rounded p-5">
														<span class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
															...
															Fakultas : <?= $data_user->fakultas->fakultas; ?>
															<br>
															<?php if (Yii::$app->user->identity->role == 3) : ?>
																Jurusan : <?= $data_user->jurusan->jurusan; ?>
															<?php endif; ?>
														</span>
